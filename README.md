...
```bash
git clone https://huggingface.co/liuhaotian/llava-v1.5-mlp2x-336px-pretrain-vicuna-7b-v1.5 # for llava-v1.5-7b
git clone https://huggingface.co/liuhaotian/llava-v1.5-mlp2x-336px-pretrain-vicuna-13b-v1.5 # for llava-v1.5-13b
```
Refer to [models](https://github.com/haotian-liu/LLaVA/blob/main/docs/MODEL_ZOO.md) for more choices.

Start training with different models. Set the data path to full-data and selected data.
```bash
bash finetune_7b.sh # for full-model training
bash finetune_lora.sh # for LoRA training
bash finetune.sh # for 13b training
```
